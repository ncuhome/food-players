      ...
      >
        <div class="rule_2">
          <p style="width: 100%;text-align: center;font-size: .38rem; margin-bottom: .2rem;">游戏介绍</p>
            游戏说明：每题仅可在规定时间内选择一次，且每题答题时间会逐渐变少。完整参与游戏还有机会获得小家园周边奖品券一份！
            关于奖品券说明(敲黑板!）
            1.公平起见，仅参考大家首次参与正确率哦；
            2.正确率需不小于80%；
            3.第一次游戏结束后，不会提醒玩家，但如果正确率达到要求系统会自动帮忙领取奖品券哦；
            4.获券的玩家再一次进入开始页面点入“我的奖品券”就可以看到啦；
            5.记得关注家园QQ及时获取兑换时间以及地点呀。
          <div class="togame" id="togame">
            <span>由此上滑进入美食世界</span>
          </div>
        </div>
      </div>
    </transition>
